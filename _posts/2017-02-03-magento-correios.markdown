...
excerpt: "Veja as funcionalidades do módulo Magento Correios, com suporte ao Cálculo do frete, Impressão de etiquetas via SIGEP onde o código de rastreamento é automaticamente inserido no pedido, Rastreamento, Notificação automática do rastreamento."
---
...
<div class="">
    <a class="fab google-red" data-g-action="Anthem - Video Start"
        ...
        "/assets/images/docs/2017-02-03-magento-correios.gif">
    ...
    <div data-glue-modal="magento-correios" data-rs-modal="" id=
        ...
        <iframe allowfullscreen="" frameborder="0" height="100%" src=
            "/assets/images/docs/2017-02-03-magento-correios.gif" type=

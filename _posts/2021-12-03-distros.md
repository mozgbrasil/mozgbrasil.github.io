...
snap refresh --list # Liste as atualizações sem instalá-las

sudo killall snap-store
sudo snap refresh # atualizo tudo
...
git config --local user.email "marcio.amorim@mjv.com.br"

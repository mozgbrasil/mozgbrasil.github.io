...
# Performance
	...
	# Remount
		...
		rm -fr var/backups/ var/cache/ var/composer_home/ var/log/ var/page_cache/ var/session/ var/tmp/ var/view_preprocessed/ pub/static/*
		php bin/magento cache:flush
		# Recompile the pub static folder
		php bin/magento setup:static-content:deploy -f
...
# Config Memcached
	...
	# Clean Cache
		...
		rm -fr var/backups/ var/cache/ var/composer_home/ var/log/ var/page_cache/ var/session/ var/tmp/ var/view_preprocessed/
		php bin/magento cache:flush

...
## Sincronia entre maquinas locais
    ...
    rsync --archive --compress --verbose --progress /home/marcio/dados/mozgbrasil/ marcio@192.168.0.2:/home/marcio/dados/mozgbrasil/
...
## Sincronia entre maquinas e dispositivo USB
    ...
    rsync --archive --compress --verbose --progress ~/dados/mozgbrasil /media/marcio/HDJMicron/dados/mozgbrasil-0806/
...
# Recursively fix bad file permissions
  ...
  # A common suggestion is to use which means:
    ...
    find /home/marcio/dados/mozgbrasil/ -not \( -wholename "*.git*" -prune \) -type f -exec echo $@ {} \;

    find /home/marcio/dados/mozgbrasil/ -not \( -wholename "*.git*" -prune \) -type d -exec echo $@ {} \;

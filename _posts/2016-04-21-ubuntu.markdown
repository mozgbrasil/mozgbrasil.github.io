...
## apt install
    ...
    sudo apt install build-essential ubuntu-restricted-extras linux-tools-generic libavcodec-extra net-tools gdebi-core gnome-tweaks git p7zip-full meld curl gufw lame openssh-server jq preload indicator-cpufreq

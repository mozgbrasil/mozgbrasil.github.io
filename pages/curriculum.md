...
Venho desenvolvendo o seguinte projeto [frontend](http://aws-mozgapp.4c8p5qkwgr.us-west-2.elasticbeanstalk.com/magento/ "frontend") e [backend](http://aws-mozgapp.4c8p5qkwgr.us-west-2.elasticbeanstalk.com/magento/admin/ "backend") utilizando a plataforma Magento2, o projeto está sendo usado para automação de integração continua e usado para exibir todos os módulos que desenvolvi para a plataforma [Magento2](https://magento.com/ "Magento2"), o projeto é baseado no meu aplicativo [deploy-magento2](https://github.com/mozgbrasil/deploy-magento2 "deploy-magento2") e utiliza os diversos da [AWS](https://aws.amazon.com/pt/ "AWS") como os serviços [AWS CodeStar](https://aws.amazon.com/pt/codestar/ "AWS CodeStar"), [Elastic Beanstalk](https://aws.amazon.com/pt/elasticbeanstalk/ "Elastic Beanstalk"), [AWS RDS](https://aws.amazon.com/pt/rds/ "AWS RDS"), entre outros

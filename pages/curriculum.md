...
Venho desenvolvendo o seguinte projeto [front-end](http://magento1mozg.herokuapp.com/magento/index.php/ "front-end") e [back-end](http://magento1mozg.herokuapp.com/magento/index.php/admin/ "back-end") utilizando a plataforma Magento 1, o projeto está sendo usado para automação de integração continua e usado para exibir todos os módulos que desenvolvi para a plataforma [Magento 1](https://magento.com/ "Magento1"), o projeto é baseado no meu aplicativo [deploy-magento](https://github.com/mozgbrasil/deploy-magento "deploy-magento") que utiliza o [Composer](https://getcomposer.org/ "Composer") para a implantação na [Heroku](https://www.heroku.com/ "Heroku")

Venho desenvolvendo o seguinte [projeto](https://reactjs-portfolio.herokuapp.com/ "Portfólio") utilizando como camada front-end o [React](https://reactjs.org/ "React") e como camada back-end o [Node.js](https://nodejs.org/en/ "Node.js") tudo rodando sobre a infraestrutura da [Heroku](https://www.heroku.com/ "Heroku"), o projeto é usado como meu portfólio, o projeto é baseado no meu aplicativo [react-portfolio](https://github.com/mozgbrasil/react-portfolio "react-portfolio") que utiliza o [NPM](https://www.npmjs.com/ "NPM") para a implantação na [Heroku](https://www.heroku.com/ "Heroku")

Venho desenvolvendo o seguinte projeto usando como base a plataforma [Magento 2](https://magento.com/ "Magento 2"), e utilizando automação como [integração contínua](https://aws.amazon.com/pt/devops/continuous-integration/ "integração contínua") e efetuando a implantação no serviço [Elastic Beanstalk](https://aws.amazon.com/pt/elasticbeanstalk/ "Elastic Beanstalk") resultando no [front-end](http://648050603631-test-webapp011.us-east-2.elasticbeanstalk.com/magento/ "front-end") e [back-end](http://648050603631-test-webapp011.us-east-2.elasticbeanstalk.com/magento/admin/ "back-end"), também efetuando a implantação no serviço [Heroku](https://www.heroku.com/ "Heroku") resultando no [front-end](http://648050603631-test-webapp011.us-east-2.elasticbeanstalk.com/magento/ "front-end") e [back-end](http://648050603631-test-webapp011.us-east-2.elasticbeanstalk.com/magento/admin/ "back-end")

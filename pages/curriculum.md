...
A fim de apresentar todos os módulos que desenvolvi para a plataforma [Magento1](https://magento.com/ "Magento"), venho apresentando o seguinte projeto, caso queira acesse o [frontend](http://magento1mozg.herokuapp.com/magento/index.php/ "Magento1") e caso queira acesse o [backend](http://magento1mozg.herokuapp.com/magento/index.php/admin/ "Magento1"), no processo de autenticação para o campo usuário informe "admin" e para senha informe "123456a", após se logar veja que é exibido o menu "∞ MOZG ∞" e seus submenu contendo os diversos métodos que menciono
